create table category (id bigint not null auto_increment, desctrption varchar(255), primary key (id)) engine=InnoDB
...
create table unit_of_measure (id bigint not null auto_increment, descritpion varchar(255), primary key (id)) engine=InnoDB
